...
from algorithm import ALGORITHM_DICT, GAIL, GAILPPO, GAILTRPO
...
def main(cfg: DictConfig):
    ...
    discriminator = GAILDiscriminator(training_envs.observation_space, training_envs.action_space, device, discriminator_net)
    ...
    # create trainer 
    algorithm: GAIL | GAILPPO | GAILTRPO
